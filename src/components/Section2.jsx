...
<div className="relative">
  ...
  <div className="flex md:flex-col justify-between md:justify-start gap-8 sm:gap-12 md:gap-8">
    ...
    <div className="flex flex-col md:flex-row items-center md:space-x-6 relative z-10">
      <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white/60 font-semibold text-sm">
        2017
      </div>
    </div>
    ...
    {/* 2020 */}
    <div className="flex flex-col md:flex-row items-center md:space-x-6 relative z-10">
      <div className="w-12 h-12 rounded-full bg-folio-accent flex items-center justify-center text-white font-semibold text-sm shadow-lg shadow-purple-500/50">
        2020
      </div>
    </div>
    ...
    <div className="flex flex-col md:flex-row items-center md:space-x-6 relative z-10">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between px-6 md:px-12 lg:px-20 pb-12 md:pb-16 lg:pb-24">
        ...
        <div className="lg:w-1/3 text-center lg:text-right">
          <div className="text-6xl md:text-7xl lg:text-8xl font-bold text-folio-accent mb-2">28</div>
